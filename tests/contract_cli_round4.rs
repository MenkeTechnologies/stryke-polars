...
//! (`stryke-polars-helper --help`, exit codes, subcommand routing).
//!
...
//! The exports are exercised end-to-end by `t/test_polars.stk` (82
//! `assert_*` invocations against the native polars cdylib).
//!
