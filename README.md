...
46 wrapper modules in `lib/`, 1,505 stryke-side fns total
...
| `DataFrame.stk` | `Polars::DataFrame` | 122 |
...
| `Set.stk` | `Polars::Set` | 10 |
| `FFT.stk` | `Polars::FFT` | 8 |
| `Encoding.stk` | `Polars::Encoding` | 8 |
